...
In practicaxava-labels_en.properties:
practicaxava=My application
practicaxava[description]=My application does this and that

In practicaxava-messages_en.properties:
